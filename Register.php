...
<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		if(empty($errors)){
			$sql = "INSERT INTO userlogin (Username,Password,FirstName,MiddleName,LastName,Email) VALUES ('".$_POST["username"]."',PASSWORD('".$_POST["psw"]."'),'".$_POST["firstname"]."','".$_POST["middlename"]."','".$_POST["lastname"]."','".$_POST["email"]."')";
